  ...
  constructor(
    ...
    this._iconRegistry.addSvgIconInNamespace(
      ...
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/diy-do-it-yourself-icon.svg'
      )
    );
    this._iconRegistry.addSvgIconInNamespace(
      'assets',
    ...
    this._iconRegistry.addSvgIconInNamespace(
      ...
      'covalent-stroke',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/covalent-stroke.svg'
      )
    );
    this._iconRegistry.addSvgIconInNamespace(
      'assets',
      'covalent-outline',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/covalent-outline.svg'
      )
    );
    this._iconRegistry.addSvgIconInNamespace(
      'assets',
    ...
    this._iconRegistry.addSvgIconInNamespace(
      ...
      'angular-outline',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/angular-outline.svg'
      )
    );
    this._iconRegistry.addSvgIconInNamespace(
      'assets',
    ...
    this._iconRegistry.addSvgIcon(
      'control-center',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/control-center.svg'
      )
    );
    this._iconRegistry.addSvgIcon(
      'querygrid',
    ...
    this._iconRegistry.addSvgIcon(
      'workload-analytics',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/icons/workload-analytics.svg'
      )
    );
    this._iconRegistry.addSvgIcon(
      'unity',
