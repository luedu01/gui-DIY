...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'combination',
        loadChildren: () =>
          import('./echarts-demos/combination/combination.module').then(
            (m: any) => m.CombinationModule
          ),
      },
      {
        path: 'bar',
        loadChildren: () =>
          import('./echarts-demos/bar/bar.module').then(
            (m: any) => m.BarModule
          ),
      },
      {
      ...
      /*{
        path: 'map',
        loadChildren: () =>
          import('./echarts-demos/map/map.module').then(
            (m: any) => m.MapModule
          ),
      },*/
      {
        path: 'pie',
        loadChildren: () =>
          import('./echarts-demos/pie/pie.module').then(
            (m: any) => m.PieModule
          ),
      },
      {
        ...
        loadChildren: () =>
          import('./echarts-demos/sankey/sankey.module').then(
            (m: any) => m.SankeyModule
          ),
      },
      {
        path: 'scatter',
        loadChildren: () =>
          import('./echarts-demos/scatter/scatter.module').then(
            (m: any) => m.ScatterModule
          ),
      },
      {
        path: 'tree',
        loadChildren: () =>
          import('./echarts-demos/tree/tree.module').then(
            (m: any) => m.TreeModule
          ),
      },
      {
        path: 'treemap',
        loadChildren: () =>
          import('./echarts-demos/treemap/treemap.module').then(
            (m: any) => m.TreemapModule
          ),
      },
      {
        path: 'wordcloud',
        loadChildren: () =>
          import('./echarts-demos/wordcloud/wordcloud.module').then(
            (m: any) => m.WordcloudModule
          ),
      },
      {
        path: 'tooltip',
