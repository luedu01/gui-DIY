...
export class WordcloudDemoBasicComponent implements OnInit {
  public get themeSelector(): ChartThemeSelectorService {
    return this._themeSelector;
  }
  public set themeSelector(value: ChartThemeSelectorService) {
    this._themeSelector = value;
  }
  ...
  constructor(
    ...
    private _themeSelector: ChartThemeSelectorService
  ) {}
