...
export const componentRouteCategories: any = [
  ...
  { name: 'Flows', nested: false, color: 'td-blue' },
  { name: 'Explore', nested: false, color: 'pink-900' },
  { name: 'Schedule', nested: false, color: 'yellow-900' },
...
const [root, flows, explore, schedule/*, markdown, tour*/] =
